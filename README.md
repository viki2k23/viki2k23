...
**Remote Operations Professional | Property Management | Systems Builder**

I help U.S.-based property managers and business owners run cleaner,
more efficient operations from a distance. I specialize in building
repeatable systems, handling daily operational work, and documenting
processes that keep portfolios and businesses running consistently.
...
| Area | Details |
|---|---|
| **Property Management Ops** | Tenant communication, rent follow-up, maintenance coordination, leasing support, vendor management |
| **Systems & Documentation** | SOP creation, workflow design, process templates, operations playbooks |
| **Administrative Operations** | Client coordination, scheduling, issue resolution, multi-priority management |
| **Leasing Support** | Application tracking, lease renewals, move-in/move-out coordination, notice preparation |

---

## Tools & Software

![AppFolio](https://img.shields.io/badge/AppFolio-0078D4?style=flat&logoColor=white)
![Buildium](https://img.shields.io/badge/Buildium-00A550?style=flat&logoColor=white)
